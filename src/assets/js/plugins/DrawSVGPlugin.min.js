...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
		...
		function r(o) {
			if (!o) return 0;
			o = t(o);
			var r, n, i, s, a, f, g, d = o.tagName.toLowerCase(),
				u = 1,
				c = 1;
			"non-scaling-stroke" === o.getAttribute("vector-effect") && (c = o.getScreenCTM(), u = c.a, c = c.d);
			try {
				n = o.getBBox()
			} catch (l) {}
			if (n && (n.width || n.height) || "rect" !== d && "circle" !== d && "ellipse" !== d || (n = {
					width: parseFloat(o.getAttribute("rect" === d ? "width" : "circle" === d ? "r" : "rx")),
					height: parseFloat(o.getAttribute("rect" === d ? "height" : "circle" === d ? "r" : "ry"))
				}, "rect" !== d && (n.width *= 2, n.height *= 2)), "path" === d) s = o.style.strokeDasharray, o.style.strokeDasharray = "none", r = o.getTotalLength() || 0, u !== c && console.log("Warning: <path> length cannot be measured accurately when vector-effect is non-scaling-stroke and the element isn't proportionally scaled."), r *= (u + c) / 2, o.style.strokeDasharray = s;
			else if ("rect" === d) r = 2 * n.width * u + 2 * n.height * c;
			else if ("line" === d) r = e(o.getAttribute("x1"), o.getAttribute("y1"), o.getAttribute("x2"), o.getAttribute("y2"), u, c);
			else if ("polyline" === d || "polygon" === d)
				for (i = o.getAttribute("points").match(h) || [], "polygon" === d && i.push(i[0], i[1]), r = 0, a = 2; a < i.length; a += 2) r += e(i[a - 2], i[a - 1], i[a], i[a + 1], u, c) || 0;
			else("circle" === d || "ellipse" === d) && (f = n.width / 2 * u, g = n.height / 2 * c, r = Math.PI * (3 * (f + g) - Math.sqrt((3 * f + g) * (f + 3 * g))));
			return r || 0
		}
		...
		i = _gsScope._gsDefine.plugin({
			...
			init: function (e, t, i, s) {
				...
				if (!l) return window.location.href = "http://" + u + c + "?plugin=" + d + "&source=" + g, !1;
				var h, C, p, m, S = r(e) + 1;
