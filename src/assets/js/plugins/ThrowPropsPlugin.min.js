...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
        ...
        _gsScope._gsDefine("plugins.ThrowPropsPlugin", ["plugins.TweenPlugin", "TweenLite", "easing.Ease", "utils.VelocityTracker"], function (t, e, i, n) {
            ...
            return M.constructor = h, h.version = "0.11.0", h.API = 2, h._autoCSS = !0, h.defaultResistance = 100, h.defaultUnitFactors = {
                ...
                var o, h, l, c, d, u, v, b, x, M, A, P, T = i._ease,
                    k = isNaN(e.checkpoint) ? .05 : +e.checkpoint,
                    N = i._duration,
                    D = e.preventOvershoot,
                    E = 0;
                if (!C) return window.location.href = "http://" + _ + m + "?plugin=" + p + "&source=" + g, !1;
                if (e.linkedProps)
                    for (A = e.linkedProps.split(","), M = {}, P = 0; P < A.length; P++) o = A[P], h = e[o], h && (void 0 !== h.velocity && "number" == typeof h.velocity ? d = +h.velocity || 0 : (x = x || n.getByTarget(t), d = x && x.isTrackingProp(o) ? x.getVelocity(o) : 0), l = "function" == typeof t[o] ? t[o.indexOf("set") || "function" != typeof t["get" + o.substr(3)] ? o : "get" + o.substr(3)]() : t[o] || 0, M[o] = l + w(d, T, N, k));
                for (o in e)
                    if ("resistance" !== o && "checkpoint" !== o && "preventOvershoot" !== o && "linkedProps" !== o && "radius" !== o) {
                        ...
                        u = w(d, T, N, k), b = 0, c = "function" == typeof t[o], l = c ? t[o.indexOf("set") || "function" != typeof t["get" + o.substr(3)] ? o : "get" + o.substr(3)]() : t[o], "object" == typeof h && (v = l + u, void 0 !== h.end && (h = S(h, M && o in M ? M : v, h.max, h.min, o, e.radius), f && (e[o] = y(h, e[o], "end"))), void 0 !== h.max && +h.max < v ? D || h.preventOvershoot ? u = h.max - l : b = h.max - l - u : void 0 !== h.min && +h.min > v && (D || h.preventOvershoot ? u = h.min - l : b = h.min - l - u)), this._overwriteProps[E] = o, this._props[E++] = {
                            p: o,
                            s: l,
                            c1: u,
                            c2: b,
