<template>
  <div class="container background" id="home">
    <div class="main">
      <ul id="bk-list" class="bk-list clearfix">
        ...
        <li>
          <div class="bk-book book-3">
            ...
            <div class="bk-back">
              <img src="../assets/images/3.png" alt="cat" />
...
<script>
import Book from '../assets/js/books2.js'
export default {
  name: 'home',
  data() {
    return {
      msg: 'Home page go here'
    }
  },
  methods: {
    resetPath() {
  ...
  created() {
    ...
    // this.loader().show()
    // console.log('log inside home ' +this.$store.state.path)
  },
  mounted() {
    Book().init()
  },
...
<style src="../assets/css/home-page/main.css" scoped>

</style>
<style src="../assets/css/home-page/components.css" scoped>
