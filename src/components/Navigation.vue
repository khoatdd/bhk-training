<template>
    <section id="navigation">
        <!-- Start Nav Structure -->
        <button class="cn-button" id="cn-button" @click="toggleMenu">{{ buttonIcon }}</button>
        <div class="cn-wrapper" id="cn-wrapper" :class="{ 'opened-nav' : isOpened }">
            <ul>
        ...
        <div id="cn-overlay" class="cn-overlay" :class="{ 'on-overlay' : isOpened }" @click="isOpened = !isOpened"></div>
        <!-- End Nav Structure -->
    </section>
</template>
<script>
